...
echo -e "\t╔════════════════════════════════════════╗" | pv -qL 80
echo -e "\t║ ToolName : Beef Tool On Termux -by classy_sinchana ║" | pv -qL 80
echo -e "\t║ Instagram: @_team_sinchuu_07_       ║" | pv -qL 80
echo -e "\t║ Github: https://github.com/TeamSinchu/║" | pv -qL 80
echo -e "\t╚════════════════════════════════════════╝" | pv -qL 80
